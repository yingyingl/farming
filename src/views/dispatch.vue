    ...
    <div class="max-width m-auto home-main">
      ...
      <div class="center-main">
        <el-table :data="tableData" class="table">
          <el-table-column label="乡镇" prop="provice"></el-table-column>
          <el-table-column label="村" prop="count"></el-table-column>
          <el-table-column label="耕地总面积" prop="area"></el-table-column>
          <el-table-column label="旱碱麦种植面积" prop="areah"></el-table-column>
          <el-table-column label="种植品种" prop="variety"></el-table-column>
        </el-table>
      </div>
